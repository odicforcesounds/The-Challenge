// JAVASCRIPT IS USED TO INJECT DATA
'use strict'
  ...
  'topMenu': [
    {
      ...
      'topMenuMusicLink': '<a href="./music.html" onclick="return false;">Music</a>',
      'topMenuFunLink': '<a href="./functions.html">Fun</a>',
      'topMenuBlogLink': '<a href="./blog.html">Code</a>',
      'topMenuDeLink': '<a href="./develop.html" onclick="return false;">De</a>',
...
// LOGO
document.getElementById('logo').innerHTML = page_profile.logo

// Art
let art = document.getElementById('art')
art.innerHTML = page_profile.art

// USER PROFILE PICTURE
document.getElementById('welcome').innerHTML = 'Welcome Reader!'

document.getElementById('player1').innerHTML = page_profile.player1

// SubMenus
document.getElementById('welcome-message').innerHTML = page_profile.blog
document.getElementById('picture').innerHTML = page_profile.picture

// SOCIAL MEDIA LINKS
document.getElementById('blogspot').innerHTML = '<a href=' + page_profile.social_media[5].link + ' ' + 'target=_blank>Blogspot</a>'
document.getElementById('facebook').innerHTML = '<a href=' + page_profile.social_media[0].link + ' ' + 'target=_blank>Facebook</a>'
document.getElementById('twitter').innerHTML = '<a href=' + page_profile.social_media[1].link + ' ' + 'target=_blank>Twitter</a>'
document.getElementById('tumblr').innerHTML = '<a href=' + page_profile.social_media[2].link + ' ' + 'target=_blank>Tumblr</a>'
document.getElementById('instagram').innerHTML = '<a href=' + page_profile.social_media[3].link + ' ' + 'target=_blank>Instagram</a>'
document.getElementById('mastodon').innerHTML = '<a href=' + page_profile.social_media[4].link + ' ' + 'target=_blank>Mastodon</a>'

// SLOGAN
document.getElementById('slogan').innerHTML = page_profile.slogan
