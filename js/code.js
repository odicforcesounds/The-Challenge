...
const user_profile = {
  'intro': [
    ...
    {
      'TopMessage': '<b>A B C D F G</b> <br><br> Introduction to Functions!'
    }
  ],
  'player': [
    {
    ...
    },
    {
      ...
      'track': '<iframe style="border: 0; width: 50%; height: 42px;" src="https://bandcamp.com/EmbeddedPlayer/album=997256964/size=small/bgcol=333333/linkcol=0f91ff/track=4209853396/transparent=true/" seamless><a href="http://odicforcesounds.bandcamp.com/album/spiritual-algorithm">Spiritual Algorithm by Odicforcesounds</a></iframe>'
    }
  ],
...
function nextPage(e) {
  let i = 0;
  let j = 0;
  while( i < user_profile.postsList[i].content.length, i < user_profile.player[j].track.length) {
    let player = document.getElementById('player1');
    let post = document.getElementById('pcode1');
    player.innerHTML = user_profile.player[j].track
